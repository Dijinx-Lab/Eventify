...
class _StepSixContainerState extends State<StepSixContainer> {
  ...
  void initState() {
    ...
    if (event.eventDescription != "" &&
      ...
      selectedCategory = event.categoryId?.toString() ?? "";
    }
  ...
  _alertParentWidget() async {
    if (_descriptionController.text != "" &&
      ...
      event.eventDescription = _descriptionController.text;
      event.category = categories
          .where((element) => element.id! == int.parse(selectedCategory))
          .first;
      event.categoryId = int.parse(selectedCategory);
