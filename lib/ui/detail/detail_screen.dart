...
class _DetailScreenState extends State<DetailScreen>
  ...
  _saveEventPrefs() async {
    DiscoverScreen.eventBus.fire(UpdateEventPreference(
        bookmarked: bookmarked, preference: action, id: event.id!));
    await statsService.updateStats(action, bookmarked, event.id!);
  }
  ...
  launchEmail() async {
    ...
    final Uri _emailLaunchUri = Uri(
      scheme: 'mailto',
      path: event.contact!.email, // Replace with the recipient's email
      queryParameters: {
